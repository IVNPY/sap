...
from apps.registration import signals
from apps.registration.models import RegistrationProfile
from apps.registration.views import ActivationView as BaseActivationView
from apps.registration.views import RegistrationView as BaseRegistrationView
